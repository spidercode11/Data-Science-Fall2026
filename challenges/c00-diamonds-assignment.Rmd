...
- The graph shows that as the carat value of a diamond increases, the price increases aswell, however in higher carats ( around 4-5 carats) have same price at carats between 2-3
...
- Now there is a third variable cut, which has a legend on the side which color codes the quality of the cut of the diamond. The graph shows that the Ideal cut diamonds raise in price before the lesser cuts even if they are the same carat, however its a very small change. The carat of the diamond affects the price far greater. Additionally, higher grade cuts like Ideal and Premium tend to cluster at lower carats, while lower grade cuts like Fair appear more spread out toward higher carats though this seems to be a pattern in this particular sample rather than a strict rule, since there's still plenty of overlap across all cut grades in the lower carat range.
