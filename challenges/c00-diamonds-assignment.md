...
- The graph shows that as the carat value of a diamond increases, the
  price increases aswell, however in higher carats ( around 4-5 carats)
  have same price at carats between 2-3
...
- Now there is a third variable cut, which has a legend on the side
  which color codes the quality of the cut of the diamond. The graph
