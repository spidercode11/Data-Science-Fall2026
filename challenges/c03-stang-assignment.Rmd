...
- Is there "one true value" for the material properties of Aluminum?
  - No there isnt one true value for Aluminum because if you look at E in the summary, it has a wide spread of values for the same alloy which means there isnt one single true value.
- How many aluminum alloys are in this dataset? How do you know?
  - There is one aluminum alloy in this dataset. You can see this by looking at the glimpse and summary, there is only "al_24st" and the summary shows there is only 1 unique value in alloy column.
...
- There seems to be a loose positive cooraletion between E and nu, however it seems the relationship is more driven by the thickness of the alloy higher thickness has noticeably lower E and Nu but lower thickness has no clear relationship. Having more data on other alloy would show a more clear relationship between E and Nu.
...
- Does this graph support or contradict the claim above?
  - The graph mostly contradicts the claim. If E were intensive, all four thicknesses should scatter around roughly the same value, but the 0.081" plates are clearly lower (about 9,900 to 10,100) than the others, which sit around 10,300 to 10,700, and the two groups barely overlap.
- Is this evidence *conclusive* one way or another?
  - No, Thickness and E are related in this data, but that doesn't prove thickness is the cause, since the plates may have come from different batches or been processed differently. The trend isn't consistent across thicknesses either. To really know, you'd need to test plates of different thicknesses cut from the same stock.
